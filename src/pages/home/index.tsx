import { Text, Box, Flex, Center, Img, Heading, Button } from "@chakra-ui/react";
...
const images = ["paisagem de uma praia com rochas", "paisagem de uma praia com rochas", "paisagem de uma praia com rochas"];
        ...
        <Flex as="section" direction={{ base: "column", lg: "row" }} w="100%" h={{ base: "auto", lg: "670px" }} bg="white">
          <Box bg="white" w={{ base: "100%", lg: "40%" }} h={{ base: "auto", lg: "100%" }} pos="relative" zIndex={1}>
            <Text fontWeight="light" fontSize={{ base: 22, lg: 24 }} color="gray.700" mt={8} ml={{ base: 3, lg: 10 }}>
              ...
              quam, ac venenatis diam neque ut erat. Vestibulum suscipit varius urna ut dignissim. Duis vitae pharetra sem, vel
              dapibus lectus.
            </Text>
          ...
          <Flex direction="column" w="100%" maxW="1070px" align="center" pos="relative">
            ...
            <Flex maxW="1070px" justify={{ base: "center", xl: "space-between" }} wrap="wrap" gap={8} mt="40px">
              {images.map((img, index) => (
                <Card key={index} src={`../../../images/img${index + 1}.jpg`} alt={img} pos={index} />
              ))}
            </Flex>
            <Flex maxW="1070px" justify={{ base: "center", xl: "space-between" }} wrap="wrap" gap={8} mt={8}>
              {images.map((img, index) => (
                <Card key={index} src={`../../../images/img${index + 1}.jpg`} alt={img} pos={index} />
              ))}
            </Flex>
